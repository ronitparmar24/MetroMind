...
NODE_SERVICE_URL = config('NODE_SERVICE_URL', default='http://localhost:5000')
CORS_ALLOWED_ORIGINS = [NODE_SERVICE_URL]
CORS_ALLOW_ALL_ORIGINS = True  # In dev, allow all for testing
