...
const { getWeeklyDigest, getSpending, getHeatmap, getPersonality, getLeaderboard, getStationProfile, getNetworkPulse, getCarbonPassportPDF } = require('../controllers/analytics.controller');
...
router.get('/carbon-passport/pdf', protect, getCarbonPassportPDF);
