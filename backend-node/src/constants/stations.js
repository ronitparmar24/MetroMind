...
// All GMRC (Gujarat Metro Rail Corporation) stations with GPS coordinates
// Used for haversine distance calculation in the fare engine.
// Blue Line: Motera Stadium → APMC | Red Line: (East-West corridor)
